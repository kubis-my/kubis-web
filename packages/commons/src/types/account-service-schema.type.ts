...
export interface IQuery {
    ...
    ): PaginatedCompany | Promise<PaginatedCompany>;
    ...
    ): PaginatedUserAccount | Promise<PaginatedUserAccount>;
    ...
    ): PaginatedCompanyEmployee | Promise<PaginatedCompanyEmployee>;
    getCompanyBranches(
        companyPublicId: string,
        pagination: BranchPaginationInput,
    ): PaginatedBranch | Promise<PaginatedBranch>;
...
export interface IMutation {
    ...
    upsertCompanyBillingAddress(
        companyPublicId: string,
        input: UpsertCompanyBillingAddressInput,
    ): Company | Promise<Company>;
