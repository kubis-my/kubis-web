...
import {
    Company,
    UpsertCompanyPhysicalAddressInput,
...
> = gql`
    mutation UpsertCompanyPhysicalAddress(
        $companyPublicId: String!
        $input: UpsertCompanyPhysicalAddressInput!
    ) {
...
export default function CompanyPhysicalAddressCard() {
    ...
    const resetForm = () => {
        ...
        const data = {
            ...
            phoneCode: ctx.company?.companyPhysicalAddresses?.phoneCode || '+60',
                ...
                <Card className="@container/card cursor-pointer">
                    ...
                    <CardContent className="flex-col items-start gap-1.5 text-sm">
                        ...
                        <div className="flex items-center justify-between px-1 py-2">
                            ...
                            <div className="text-muted-foreground text-xs">
                                {ctx.company?.companyPhysicalAddresses?.phoneCode &&
                                ctx.company?.companyPhysicalAddresses?.phoneNumber
            ...
            <DrawerContent className={isMobile ? 'max-h-[85vh]' : 'max-w-md'}>
                <form onSubmit={handleSubmit} className="flex h-full flex-col">
                    <DrawerHeader className="gap-1">
                        ...
                        <DrawerDescription>
                            Make changes to your company&apos;s physical address below. Update the
