...
import { Company, CompanyPaginationInput, PaginatedCompany } from "@repo/commons/types/account-service-schema.type"
...
export function CompanyDataTable() {
    ...
    const [paginatedCompany, setPaginatedCompany] = useState<Omit<PaginatedCompany, "overview">>(createInitialPaginatedData());
    ...
    useEffect(() => {
        setPaginatedCompany(data?.getUserCompanies ?? ctx.paginatedCompany ?? createInitialPaginatedData())
