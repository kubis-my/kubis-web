...
import { BranchEvent, BranchEventPaginationInput, PaginatedBranchEvent } from "@repo/commons/types/account-service-schema.type";
...
export default function EventsTab() {
    ...
    const handleRowClick = useCallback((event: BranchEvent) => {
        router.push(`/my-account/company/${ctx.branch?.company.publicId}/branch/${ctx.branch?.publicId}/event/${event.publicId}`);
    }, [router, ctx.branch]);
