...
export default function CompanyBranchBillingAddressCard() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // TODO: Add API call to update billing address
        setOpen(false);
    };
            ...
            <DrawerContent className={isMobile ? "max-h-[85vh]" : "max-w-md"}>
                <form onSubmit={handleSubmit} className="flex flex-col h-full">
                    <DrawerHeader className="gap-1">
                        ...
                        <DrawerDescription>
                            Make changes to your branch&apos;s billing address below. Update the street, city, state, postal code, and country as needed.
                        </DrawerDescription>
                        <Separator />
                    </DrawerHeader>
