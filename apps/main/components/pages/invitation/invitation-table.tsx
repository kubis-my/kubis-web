...
export default function InvitationTable() {
    ...
    const [paginatedInvitation, setPaginatedInvitation] = useState<Omit<PaginatedCredentialInvitation, "overview">>(createInitialPaginatedData());
    ...
    const goToNextPage = useCallback(() => {
        if (paginatedInvitation.pageInfo.hasNextPage && paginatedInvitation.pageInfo.endCursor !== null) {
    ...
    useEffect(() => {
        setPaginatedInvitation(data?.getCredentialInvitations ?? ctx.paginatedInvitation ?? createInitialPaginatedData())
