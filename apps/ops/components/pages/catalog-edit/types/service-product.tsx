...
interface UpdateServiceProductResponse {
    updateServiceProductForOps: OpsProduct;
}

interface UpdateServiceProductVariables {
    companyPublicId: string;
    input: UpdateServiceProductInput;
}

const UPDATE_SERVICE_PRODUCT: TypedDocumentNode<
    UpdateServiceProductResponse,
    UpdateServiceProductVariables
> = gql`
    mutation UpdateServiceProduct($companyPublicId: String!, $input: UpdateServiceProductInput!) {
        updateServiceProductForOps(companyPublicId: $companyPublicId, input: $input) {
            publicId
            name
        }
    }
...
export function EditServiceProductForm({
    product,
    onClose,
    onDirtyChange,
}: {
    ...
    const [updateServiceProduct, { loading }] = useMutation(UPDATE_SERVICE_PRODUCT);
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            const { data, error } = await updateServiceProduct({
                variables: {
    ...
    return (
        <form id="edit-service-product-form" onSubmit={handleSubmit} className="flex w-full flex-col">
