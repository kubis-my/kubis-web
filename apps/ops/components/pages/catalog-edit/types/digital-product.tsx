...
interface UpdateDigitalProductResponse {
    updateDigitalProductForOps: OpsProduct;
}

interface UpdateDigitalProductVariables {
    companyPublicId: string;
    input: UpdateDigitalProductInput;
}

const UPDATE_DIGITAL_PRODUCT: TypedDocumentNode<
    UpdateDigitalProductResponse,
    UpdateDigitalProductVariables
> = gql`
    mutation UpdateDigitalProduct($companyPublicId: String!, $input: UpdateDigitalProductInput!) {
        updateDigitalProductForOps(companyPublicId: $companyPublicId, input: $input) {
            publicId
            name
        }
    }
...
export function EditDigitalProductForm({
    product,
    onClose,
    onDirtyChange,
}: {
    ...
    const [updateDigitalProduct, { loading }] = useMutation(UPDATE_DIGITAL_PRODUCT);
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            const { data, error } = await updateDigitalProduct({
                variables: {
