...
interface UpdateSimpleProductResponse {
    updateSimpleProductForOps: OpsProduct;
}

interface UpdateSimpleProductVariables {
    companyPublicId: string;
    input: UpdateSimpleProductInput;
}

const UPDATE_SIMPLE_PRODUCT: TypedDocumentNode<
    UpdateSimpleProductResponse,
    UpdateSimpleProductVariables
> = gql`
    mutation UpdateSimpleProduct($companyPublicId: String!, $input: UpdateSimpleProductInput!) {
        updateSimpleProductForOps(companyPublicId: $companyPublicId, input: $input) {
            publicId
            name
        }
    }
...
export function EditSimpleProductForm({
    product,
    onClose,
    onDirtyChange,
}: {
    ...
    const [updateSimpleProduct, { loading }] = useMutation(UPDATE_SIMPLE_PRODUCT);
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            const { data, error } = await updateSimpleProduct({
                variables: {
    ...
    return (
        <form id="edit-simple-product-form" onSubmit={handleSubmit} className="flex w-full flex-col">
